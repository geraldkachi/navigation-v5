...
const HomeStackScreen = ({navigation}) => (
    <HomeStack.Navigator screenOptions={{
        ...
        options={{ title:"HomeScreen",
            headerLeft:()=> (   <MaterialCommunityIcons name="menu" style={{marginHorizontal: 15}} color="white" size={26} onPress={()=> navigation.openDrawer() }  /> )  
            }} />
...
const DetailStackScreen = ({navigation}) => (
    <DetailStack.Navigator screenOptions={{
        ...
        <DetailStack.Screen name="Home" component={DetailScreen} options={{ title:"HomeScreen", headerLeft:()=> (<MaterialCommunityIcons name="menu" color="white" style={{marginHorizontal:15}} size={26} onPress={()=> navigation.openDrawer() }  />)  }} />
